...
function Hero({
    ...
    return (
        <div
            className="overflow-clip relative h-screen w-full bg-gradient-to-b from-transparent flex flex-row items-center justify-between to-black box-border">
            {renderHeroImage()}
        ...
        /> */}
                ...
                <section className="hidden  lg:h-full lg:flex lg:flex-row lg:items-center lg:justify-center sm:pt-20 p">
                    ...
                    />
                    <div
                        className="h-full -ml-24 w-60 bg-gradient-to-b from-current via-transparent to-[rgba(255,255,255,0.08)] "></div>
                </section>
            </div>
            ...
            <h2 className="text-white uppercase text-2xl ml-0 absolute mt-[20em] font-semibold text-center sm:hidden">
                ...
                we're betting on
                <span className="text-yellow-500 ml-2 font-extralight">ambitious founders </span>
            ...
            <div className="bg-right-gradient w-[20%] h-full hidden sm:flex sm:items-start sm:justify-center">
                <button
                    className="h-12 w-36 rounded-full bg-white font-medium mt-[3rem] capitalize font-poppins  text-xl">
