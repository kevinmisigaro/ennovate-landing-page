...
const Hero = () => {
  return (
    <div className="">
      ...
      />
      <div className="absolute top-0 left-0 opacity-90 h-full w-full">
        <div className="flex flex-col items-center justify-evenly md:justify-start sm:w-1/2 h-full">
          <div className=" flex-row items-center justify-center lg:mt-24 lg:mb-12  hidden sm:flex">
            <div className="size-8 rounded-full bg-yellow-500"></div>
            <div className="w-full sm:mt-12">
              <h2 className="text-white text-2xl sm:text-5xl font-bold ml-6">
                TheNextHub
              </h2>
              <h2 className="text-white text-xl sm:text-5xl font-normal ml-6">
                By Ennovate Ventures
              </h2>
            </div>
          </div>
          <h1 className="font-semibold text-2xl md:ml-12 w-full lg:text-5xl text-white text-center md:w-[100%] sm:my-12">
            Tanzania’s First
            <span className="text-yellow-500 mx-2">
              Open Digital Innovation Lab
            </span>
            that is Enabling Africa's
            <span className="text-yellow-500 mx-2">NEXT</span> Big Companies
          </h1>
        </div>
      </div>
    </div>
    ...
    <div className="h-full w-full flex flex-col sm:flex-row items-center justify-between">
      <div className="h-full w-full sm:w-2/3 my-2 mx-4 pattern-2 p-8 rounded-xl">
        ...
        <p className="text-xl tracking-wide leading-9 text-white">
          The <strong className="text-[#feba00]">NextHub</strong> is the first integrated
          <strong className="text-[#feba00]"> IdeaLab </strong> in Tanzania, building a
          <strong className="text-[#feba00]"> pipeline of the most disruptive innovations</strong> powering
          smart cities, the blue economy, and tech talents for the future of
          work. The IdeaLab is
          <strong >
...
const HubProgrammes = () => {
  return (
    <div className="h-screen w-full flex flex-row items-center justify-center">
      <div className="h-full hidden sm:block w-1/3">
        <img
          src={presenter}
          alt=""
          className="h-full w-fit border-r-8 border-yellow-500"
        />
      </div>
      <div className="h-full w-full sm:w-2/3 flex flex-col items-center justify-evenly bg-[#120d28]">
        <div>
          <h1 className="font-bold text-yellow-500 text-xl md:text-3xl">
            TheNextHub <span className="text-white"> Programmes</span>
          </h1>
        </div>
        <div className="flex flex-row items-center justify-evenly flex-wrap w-[70%]">
          {nextHubProgrammes.map((item) => (
            <div className="mx-8 my-4">
              <Link className="" to={"/" + item.route}>
                <img src={item.icon} alt="" className="size-20" />
                <h2 className="text-white font-bold text-xl no-underline w-24 text-wrap">
                  {item.title}
                </h2>
              </Link>
            </div>
      ...
      <div className="mx-auto max-w-2xl py-32">
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
            Tanzania’s First{" "}
            <span className="text-[#feba00]">Open Digital Innovation Lab</span>{" "}
            that is Enabling Africa's{" "}
            <span className="text-[#feba00]">NEXT</span> Big Companies
          </h1>
        </div>
      </div>
      <div
    ...
    <div>
      <ul className="example-2">
        <li className="icon-content">
          ...
          <div class="tooltip">Gender-Lens Programming </div>
        </li>
        <li className="icon-content">
          <a
...
function NextHub() {
  return (
    <div className="pattern w-full h-fit">
      ...
      <HeroSection />
      <PartTwo />
      <section className="flex flex-row items-center justify-evenly w-[90%] mx-[5%] my-12 rounded-xl flex-wrap h-1/2 p-16 pattern-2">
