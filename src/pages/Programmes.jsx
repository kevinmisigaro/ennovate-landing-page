  ...
  return (
    <div className="bg-black">
      <NextFundHero
        hero={heroGuy}
        textDescription={
          <h1 className="text-4xl ml-12 font-bold tracking-tight text-white sm:text-5xl sm:w-[12em]">
            We work with corporates and development partners to design and
            implement entrepreneurship programmes to scale innovative solutions
            across Africa
          </h1>
        }
      />
